...
# PARAMETERS
params=`sed "$((IDX+1))q;d" /scratch1/xwang505/twas_sim/twas_sim/param_twas_sim.tsv`
echo "$((IDX+1)) ${params}"
set -- junk $params
shift
...
do
  ...
  python /scratch1/xwang505/twas_sim/twas_sim/sample_genes.py \
  $loci \
  $genes \
  -l $lower \
  -u $upper \
...
python /scratch1/xwang505/twas_sim/twas_sim/sim.py \
...
--locus ${locus} \
--sim ${SIM} \
--output /scratch1/xwang505/twas_sim/twas_sim_results2/twas_sim${SIM}_loci${locus}
